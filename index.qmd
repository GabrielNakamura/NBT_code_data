...
-   [`function_beta_types_success_fail.R`]() function used to calculate native/endemic deficit and non-native/
    non-endemic representation.

-   [`function_scale_back.R`]() auxiliar function used to transform back normalized variables
