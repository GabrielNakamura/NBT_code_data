...
-   `spp_native_distribution.csv` data frame in the long format
    ...
    -   `species` character. The name of a species in the format genus_epithet
        according to the Catalog of Fishes (including synonym names)
...
- [`0011_V_beta_all_FigS3.qmd`]() code to produce the Figure S3 in the supplementary material
    producing a cartogram with countries coloured accoridng to its native and NBT 
    turnover values, considering all species
