...
subtitle: "07_V_scatterplot_Fig2.qmd"
eval: true
warning: false
knitr: 
  opts_chunk:
...
:::callout-note
The final figure presented in the manuscript is further edited with
    the aid of inkscape software
:::
...
flow_period_region_prop_lag |>
  # dplyr::mutate(dplyr::across(c(prop_DC, prop_DR, 
  #                               new_DC, new_DR), 
  #                             ~ ifelse(is.na(.), 0, .))) |> 
...
ggsave(filename = here::here("output", "figures", "Fig2_DC_DR.svg"), 
       width = 8, height = 5)
```