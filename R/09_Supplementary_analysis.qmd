...
subtitle: "09_Supplementary_analysis.qmd"
format: html
eval: true
warning: false
fig-align: "center"
...
In this document we provide the code to reproduce the Figures and Tables presented in supplementary material of the manuscript **"The hidden biodiversity knowledge split in biological collections"**
...
# Calculating native deficit and non-native representation metrics with full native dataset
...
## Calculating native defict and non-native representation

Here we calculate the values of native deficit (proportion of native species lacking in a country's biological collections)
    and the proportion of name bearers that corresponds to non native species 
...
# Plotting native deficit and non-native representation for each country

In this section we present the cartogram of world map with values of native deficit and 
    non-native representation using the full dataset of native species (Figure S2)
...
We performed correlations between native deficit and non-native representation calculated using
...
QQ-plots and residuals x predicted plots using DHARMa package. These plots are 
    used to compose the Figure S3 in the Supplementary material
