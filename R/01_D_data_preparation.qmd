...
subtitle: "01_D_data_preparation.qmd"
format: html
eval: TRUE
warning: false
knitr: 
...
Data containing Name Bearing Types (simply name bearers) flow. This data frame contains the flow of name bearers
    among countries. The source country of the name bearers is represented by its three 
    ...
    name bearers flowing is represented by 50-year time intervals. The total number of 
    name bearers flowing from one region/country to another is represented by the column
